            ...
            <div class='review-slider'>
                <div class="swiper-container swiper-review-top">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <img src='<?php echo get_template_directory_uri() ?>/assets/images/catalog-image-3.png'
                                 alt=''>
                        </div>
                        <div class="swiper-slide">
                            <img src='<?php echo get_template_directory_uri() ?>/assets/images/catalog-image-4.png'
                                 alt=''>
                        </div>
                    </div>
            ...
            <div class="swiper-slide">
                <div class='previously-item'>
                    <div class='item-image'>
                        ...
                        <div class='item-bg'>
                            <div class='border'>
                                <img src='<?php echo get_template_directory_uri() ?>/assets/images/icons/enlarge.svg'
                                     alt=''>
                            </div>
                        </div>
                    </div>
